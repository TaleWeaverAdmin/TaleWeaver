...
SECRET_SETTING_KEYS = {
    ...
    "comfy_remote_auth_token",
    "comfy_cloud_auth_token",
}
MASKED_SECRET_VALUE = "********"
    ...
    with connect() as conn:
        conn.executescript(
            ...
            CREATE TABLE IF NOT EXISTS visual_styles (
                ...
                sprite_comfy_provider TEXT,
                background_workbench TEXT,
                background_comfy_provider TEXT,
                ...
                expression_comfy_provider TEXT,
                expression_prompts TEXT NOT NULL DEFAULT '{}',
                cover_path TEXT,
    ...
    for item in DEFAULT_VISUAL_STYLES:
        conn.execute(
            ...
            INSERT INTO visual_styles (
                ...
                sprite_workbench, sprite_comfy_provider, background_workbench, background_comfy_provider, background_prompt_prefix,
                ...
                background_prompt_example, appearance_workbench, appearance_comfy_provider, appearance_prompt_command, appearance_prompt_example,
                appearance_reference_workbench, appearance_reference_comfy_provider, appearance_reference_prompt_command, appearance_reference_prompt_example,
                expressions_enabled, expression_prompts_visible, expression_workbench, expression_comfy_provider,
            ...
            (
                ...
                item.get("sprite_comfy_provider") or "",
                item.get("background_workbench") or "",
                item.get("background_comfy_provider") or "",
                ...
                item.get("expression_comfy_provider") or "",
    ...
    with connect() as conn:
        conn.execute(
            ...
            (
                ...
                data["sprite_comfy_provider"],
                data["background_workbench"],
                data["background_comfy_provider"],
                ...
                data["expression_comfy_provider"],
